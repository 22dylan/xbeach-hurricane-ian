...
sudo apt install subversion gcc gfortran build-essential libhdf5-dev libnetcdf-dev libnetcdff-dev netcdf-bin openmpi-bin openmpi-doc libopenmpi-dev python-is-python3 python3-mako
...
make
sudo make install
sudo ldconfig  # note; may need to run this.
